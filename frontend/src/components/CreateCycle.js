            ...
            <MainLayout title="Create Cycle">
                  <form className="cycleForm" onSubmit={onSubmit}>
                    <div className="form-group dateFields">
                            ...
                            <Row>
                                <Col><label>Start Date: </label>         
                                    <DatePicker selected={startDate}
                                                        onChange={onChangeStartDate}/>
                                </Col>
                                <Col> <label>End Date: </label>
                        ...
                        <label className="boldLabel">Add Member</label>
                                ...
                                return (
                                    ...
                                    <div className="singleOwnerField" key={index}>
                                            ...
                                            <Row>                                                                  
                                                ...
                                                <Col>
                                                    <button   className="btn btn-danger minusMember" onClick={() => removeFields(index)}>- Member</button>
                                                </Col>
                                            </Row> 
                                                ...
                                                {input.goals.map((goal,i)=>{
                                                            ...
                                                            <Button className="subtask-btn" onClick={() => addSubTask(index,i)} > + subtask </Button>    
                                                            </div>
                                                            )
                            ...
                            <div className="plusMember">
                                <button  onClick={addFields}type="button" className="btn btn-dark plusMember"> + Member</button>
                            </div>
                        </div>
                ...
                <div className="form-group" > 
                    ...
                    <div className="form-group btnSection">
                                <input type="submit" value="Create Cycle" className="btn  btn-dark createCycle"/>                                                
                    </div>
            </form>
                                </MainLayout>
        </Container>
